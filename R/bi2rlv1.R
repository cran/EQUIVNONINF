bi2rlv1 <- function(m,n,rho1,rho2,alpha,p1,p2)  {
...
{  
  ...
  pownrc <- pownrc + (pagtc1mi-pagtc1) * (1-0.5*ic1eqc2) +
    (pagtc2mi-pagtc2) * (1-0.5*ic1eqc2)
  probs <- 0
  for (ix in ixl:ixu)
...
cat("\n","m= ",m,"  n= ",n," rho1= ",rho1," rho2= ",rho2," alpha= ",alpha, "p1= ",p1,"  p2= ",p2,
    "\n","  POWNR=",pownr,"  POW=",pow)
